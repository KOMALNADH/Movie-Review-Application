...
<html>
<head>
<link rel="stylesheet" href="/resources/css/movieData.css">
...
<br><br>
<c:set var="Anime" value="MovieData"></c:set>
<center><img src="${MovieData.link}" width="175" height="230" alt="${MovieData.name}"></center>
<h3>${MovieData.name}</h3>
<h2 class="rating1">rating:-  ${MovieData.rating}</h2>
<h2 class="rating1">${MovieData.description}</h2>
<br><br>
<h2 class="rating1">comments</h2>
<form:form action="/addmovieReview/${MovieData.id}" method="post" modelAttribute="reviewForm">
<table>
	  <tr>
